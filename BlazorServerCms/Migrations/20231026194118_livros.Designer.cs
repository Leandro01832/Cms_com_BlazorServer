...
namespace BlazorServerCms.Migrations
{
    ...
    [Migration("20231026194118_livros")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("business.business.Book.UserBook", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("UserBook");
                });

            modelBuilder.Entity("business.business.Book.UserBook1", b =>
                {
                    b.HasBaseType("business.business.Book.Livro");
                    ...
                    b.HasDiscriminator().HasValue("UserBook1");
                });

            modelBuilder.Entity("business.business.Book.UserBook10", b =>
                {
                    b.HasBaseType("business.business.Book.Livro");
                    ...
                    b.HasDiscriminator().HasValue("UserBook10");
                });

            modelBuilder.Entity("business.business.Book.UserBook2", b =>
                {
                    b.HasBaseType("business.business.Book.Livro");
                    ...
                    b.HasDiscriminator().HasValue("UserBook2");
                });

            modelBuilder.Entity("business.business.Book.UserBook3", b =>
                {
                    b.HasBaseType("business.business.Book.Livro");
                    ...
                    b.HasDiscriminator().HasValue("UserBook3");
                });

            modelBuilder.Entity("business.business.Book.UserBook4", b =>
                {
                    b.HasBaseType("business.business.Book.Livro");
                    ...
                    b.HasDiscriminator().HasValue("UserBook4");
                });

            modelBuilder.Entity("business.business.Book.UserBook5", b =>
                {
                    b.HasBaseType("business.business.Book.Livro");
                    ...
                    b.HasDiscriminator().HasValue("UserBook5");
                });

            modelBuilder.Entity("business.business.Book.UserBook6", b =>
                {
                    b.HasBaseType("business.business.Book.Livro");
                    ...
                    b.HasDiscriminator().HasValue("UserBook6");
                });

            modelBuilder.Entity("business.business.Book.UserBook7", b =>
                {
                    b.HasBaseType("business.business.Book.Livro");
                    ...
                    b.HasDiscriminator().HasValue("UserBook7");
                });

            modelBuilder.Entity("business.business.Book.UserBook8", b =>
                {
                    b.HasBaseType("business.business.Book.Livro");
                    ...
                    b.HasDiscriminator().HasValue("UserBook8");
                });

            modelBuilder.Entity("business.business.Book.UserBook9", b =>
                {
                    b.HasBaseType("business.business.Book.Livro");
                    ...
                    b.HasDiscriminator().HasValue("UserBook9");
                });
